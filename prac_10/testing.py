...
def run_tests():
    ...
    new_car = Car()
    assert new_car.fuel == 0, "Car does not set the default fuel correctly"
...
def phrase_to_sentence(phrase):
    """ Format a given phrase into a sentence
    >>> phrase_to_sentence('hello')
    'Hello.'
    >>> phrase_to_sentence("It is an ex parrot")
    'It is an ex parrot.'
    >>> phrase_to_sentence("i like dogs")
    'I like dogs.'
    """

    formatted_sentence = phrase[0].upper() + phrase[1:]
