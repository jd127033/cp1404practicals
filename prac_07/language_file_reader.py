...
def main():
    ...
    for line in in_file:
        ...
        pointer_arithmetic = parts[4] == "Yes" # Add pointer arithmetic
...
def using_namedtuple():
    ...
    Language = namedtuple('Language', 'name, typing, reflection, year, pointer_arithmetic') # Add pointer arithmetic to tuple
    reader = csv.reader(in_file)  # use default dialect, Excel
